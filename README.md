...
- **[ User can add and delete todo item]**
- **[ Users can also edit an item to update the list ]**
...
Clone this repository to your desired folder. Use the command: git clone https://github.com/devalibello/react-todo-app.git
...
- [ ] **[Enable local storage of user data]**
...
I would like to thank Ibas Majeed Ibas Majeed for providing a comprehensive tutorial on how to design the app.
